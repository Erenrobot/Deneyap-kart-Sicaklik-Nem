...
#define WLAN_SSID       "FiberHGW_ZTUZ6A_2.4GHz"         // Baglanti kurulacak Wi-Fi agi adi
#define WLAN_PASS       "Eb7FXNeHtR"         // Baglanti kurulacak Wi-Fi agi sifresi
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                  
#define AIO_USERNAME    "Eren_Sadikoglu"         // Adafruit IO kullanici ismi
#define AIO_KEY         "aio_CYRU99N0pEM8qRMmuVtY7O5zpDuW"         // Adafruit IO kullanici anahtari

LSM6DSM imu;  //IMU için Class tanımlaması

WiFiClient client;
Adafruit_MQTT_Client mqtt(&client, AIO_SERVER, AIO_SERVERPORT, AIO_USERNAME, AIO_KEY);       
Adafruit_MQTT_Publish sicaklik = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/deneme");
